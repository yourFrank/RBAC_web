        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <button class="btn btn-success" onclick="assignPermission()">分配许可</button>
...
<script type="text/javascript">
    ...
    function assignPermission() {
        ...
        var jsonData="role_id=${param.id}";
        $.each(nodes,function (i,node) {
            jsonData+=("&permissionIds="+node.id);
        })
        $.ajax({
            url:"${APP_PATH}/permission/assignPermission",
            method:'POST',
            data:jsonData,
            success:function (result) {
                if (result.success){
                    ...
                    layer.msg("分配权限失败", {time:1000, icon:6}, function () {
                    });
                }
    ...
    var setting = {
        ...
        async: {
            enable: true,
            url:"${APP_PATH}/permission/loadAssignedData?role_id="+${param.id},
