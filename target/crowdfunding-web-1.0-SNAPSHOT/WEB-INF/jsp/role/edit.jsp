                ...
                <div class="panel-body">
                    <form role="form " id="addroleForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="roleName" value="${role.roleName}"  id="roleName" placeholder="请输入角色名称">
                        </div>

                        <button type="button" class="btn btn-success" onclick="addrole()"><i class="glyphicon glyphicon-plus"></i> 更新</button>
        ...
        $.ajax({
            ...
            success : function (result) {
                ...
                if (result.success) {
                    ...
                    window.location.href='${APP_PATH}/role/role';
                }
                else {
