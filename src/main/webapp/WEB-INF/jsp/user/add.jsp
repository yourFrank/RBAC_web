                ...
                <div class="panel-body">
                    <form role="form " id="addUserForm">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="loginAccount" id="loginAccount" placeholder="请输入登陆账号">
                        </div>
                        <div class="form-group">
    ...
    var loginAccount=$("#loginAccount").val();
       ...
       $.ajax({
           ...
           success : function (result) {
               ...
               if (result.success) {
                   layer.msg("新增用户成功", {time:1000, icon:6}, function () {});
                    window.location.href='${APP_PATH}/user/index';
               }
               else {
                   layer.msg("新增用户失败", {time:1000, icon:5, shift:6}, function () {
                   });
